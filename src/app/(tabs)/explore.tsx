	...
	return (
		...
		>
			...
			<Collapsible title='File-based routing'>
				...
				<ThemedText>
					The layout file in{' '}
					<ThemedText type='defaultSemiBold'>app/(tabs)/_layout.tsx</ThemedText> sets
			...
			<Collapsible title='Light and dark mode components'>
				<ThemedText>
					...
					<ThemedText type='defaultSemiBold'>useColorScheme()</ThemedText> hook lets
					you inspect what the user's current color scheme is, and so you can adjust
